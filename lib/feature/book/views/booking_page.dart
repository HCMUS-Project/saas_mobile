...
class _BookingPageState extends State<BookingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:authenticateProvider.token == null ?Container(
        child: Center(
                              ...
                              onTap: () async {
                                if (chosenService == null) {
                                  ...
                                  final timeEndConvert = chosenService
                                      ...
                                      .split(":");
                                  final duration =
                                      chosenService?.timeService?['duration'];
                                  final startHour = timeStartConvert?[0];
                                  final startMinute = timeStartConvert?[1];
                                  ...
                                  final step = Duration(minutes: duration);
                                  ...
                                  print(slotBooking);
                                  print("Slot booking: ${slotBooking.length}");
                                  ...
                                  setState(() {
                                    listTime = ShowTimeForBooking(
                                        callback: (employee) {
                                          ...
                                          print(listEmployee);
                                          setState(() {
                                            listEmployee = ListView.builder(
                                              scrollDirection: Axis.horizontal,
                                              itemCount: employee.length,
                                              itemExtent: 70,
                                              itemBuilder: (context, index) {
                                                final employ = employee[index];
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text("Choose employees that you like"),
                                    Icon(Icons.arrow_forward_ios_outlined)
                                  ],
                                ),
                              ),
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    context.read<BookingProvider>().flushData();
                                    final result = context
                                        .read<BookingProvider>()
                                        .httpResponseFlutter;
