...
class _OrderDetailState extends State<OrderDetail> {
          ...
          child: Column(
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                              flex: 8,
                              child:
                                  Container(child: Text("OrderId: $orderId"))),
                          Flexible(
                              flex: 2,
                              child: Container(
                                height:
              ...
              Row(
                children: [
                  Text(
                      "$numberOfProduct ${numberOfProduct.toString() == 1.toString() ? "item" : "items"}",style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        fontWeight: FontWeight.bold
                      ),),
                ],
              ),
              ...
              Align(
                ...
                child: Text("Order information", style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  fontWeight: FontWeight.bold
                ),),
              ),
  ...
  Future<List<Widget>> fetchItem(
    ...
    for (int i = 0; i < products.length; i++) {
      ...
      print(product);
      HttpResponseFlutter response = await context
          .read<ShopProvider>()
          .findProduct(
